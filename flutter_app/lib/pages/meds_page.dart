      ...
      builder: (context) => AlertDialog(
        ...
        content: TextField(
          ...
          decoration: const InputDecoration(
              hintText: 'Enter quantity to add', border: OutlineInputBorder()),
        ),
        actions: [
          TextButton(
                            ...
                            return ListView(
                              ...
                              children: [
                                ...
                                if (medications.isEmpty)
                                  const Center(
                                      child:
                                          Text("No medications in inventory."))
                                else
                                  ...medications.map(
                                      (m) => _buildCard(context, m, dbService)),
  ...
  Widget _buildCard(BuildContext context, Medication med, DatabaseService db) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border:
            Border.all(color: isLow ? Colors.red.shade100 : Colors.transparent),
        boxShadow: [
          BoxShadow(
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Text(_getIcon(med.category),
            ...
            onSelected: (val) {
              if (val == 'edit') {
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            AddMedicationPage(medication: med)));
              } else if (val == 'delete') {
